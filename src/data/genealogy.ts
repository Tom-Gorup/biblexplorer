...
const ch1_adamToNoah: Person[] = [
  ...
  { id: 'noah', name: 'Noah', significance: 'major', tribe: 'pre-tribal', sources: ['1chr', 'luke'], chroniclesRef: '1 Chr 1:4', crossReferences: ['Gen 5:28-9:29', 'Matt 24:37-38', 'Heb 11:7', '1 Pet 3:20', '2 Pet 2:5'], roles: ['patriarch', 'shipbuilder'], description: 'Righteous man who built the ark. God preserved him and his family through the flood.' },
];
...
const ch1_abraham: Person[] = [
  ...
  { id: 'keturah', name: 'Keturah', significance: 'minor', tribe: 'pre-tribal', sources: ['1chr'], chroniclesRef: '1 Chr 1:32', crossReferences: ['Gen 25:1-4'], gender: 'female', description: 'Abraham\'s wife after Sarah. Mother of six sons.' },
...
const ch1_esau: Person[] = [
  ...
  { id: 'timna', name: 'Timna', significance: 'minor', tribe: 'edom', sources: ['1chr'], chroniclesRef: '1 Chr 1:39', crossReferences: ['Gen 36:12,22'], gender: 'female', description: 'Sister of Lotan. Concubine of Eliphaz, mother of Amalek.' },
...
const ch2_sonsOfIsrael: Person[] = [
  ...
  { id: 'judah', name: 'Judah', significance: 'major', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 2:1', crossReferences: ['Gen 29:35', 'Gen 38', 'Gen 49:8-12', 'Matt 1:2-3'], roles: ['patriarch'], description: 'Fourth son of Jacob by Leah. The royal tribe — from his line came David and the Messiah.' },
...
const ch2_judahLine: Person[] = [
  ...
  // Perez line to David
  { id: 'hezron', name: 'Hezron', significance: 'notable', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 2:5', crossReferences: ['Gen 46:12', 'Ruth 4:18', 'Matt 1:3'], description: 'Son of Perez. Key link in the line to David.' },
  ...
  { id: 'amminadab', name: 'Amminadab', significance: 'minor', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 2:10', crossReferences: ['Ruth 4:19-20', 'Matt 1:4'], description: 'Son of Ram.' },
  { id: 'nahshon', name: 'Nahshon', significance: 'notable', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 2:10', crossReferences: ['Num 1:7', 'Num 2:3', 'Ruth 4:20', 'Matt 1:4'], roles: ['leader'], description: 'Son of Amminadab. Leader of Judah during the wilderness wandering.' },
  { id: 'salma', name: 'Salma', alternateNames: ['Salmon'], significance: 'minor', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 2:11', crossReferences: ['Ruth 4:20-21', 'Matt 1:4-5'], description: 'Son of Nahshon, father of Boaz.' },
  ...
  { id: 'boaz', name: 'Boaz', significance: 'notable', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 2:11-12', crossReferences: ['Ruth 2-4', 'Matt 1:5'], roles: ['kinsman-redeemer'], description: 'Married Ruth the Moabitess. Kinsman-redeemer. Great-grandfather of David.' },
  { id: 'ruth', name: 'Ruth', significance: 'notable', tribe: 'judah', sources: ['1chr', 'matt'], chroniclesRef: '1 Chr 2:12', crossReferences: ['Book of Ruth', 'Matt 1:5'], gender: 'female', roles: ['ancestress of David'], description: 'Moabite woman of great loyalty. "Where you go I will go." Great-grandmother of David.' },
  { id: 'obed', name: 'Obed', significance: 'minor', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 2:12', crossReferences: ['Ruth 4:17,21-22', 'Matt 1:5'], description: 'Son of Boaz and Ruth. Grandfather of David.' },
  { id: 'jesse', name: 'Jesse', significance: 'notable', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 2:12-13', crossReferences: ['1 Sam 16:1-13', 'Isa 11:1,10', 'Matt 1:5-6', 'Acts 13:22'], description: 'Father of David. From Bethlehem. Called "Jesse of the stump" in messianic prophecy.' },
...
const ch3_davidLine: Person[] = [
  ...
  { id: 'azariah-king', name: 'Azariah', alternateNames: ['Uzziah'], significance: 'notable', tribe: 'judah', sources: ['1chr', 'matt'], chroniclesRef: '1 Chr 3:12', crossReferences: ['2 Kgs 15:1-7', '2 Chr 26', 'Isa 6:1'], roles: ['king'], description: 'Long-reigning king struck with leprosy for burning incense in the Temple. Isaiah\'s call came the year he died.' },
  ...
  { id: 'shealtiel', name: 'Shealtiel', significance: 'minor', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 3:17', crossReferences: ['Ezra 3:2', 'Matt 1:12', 'Luke 3:27'], description: 'Son of Jehoiachin.' },
  ...
  { id: 'zerubbabel', name: 'Zerubbabel', significance: 'notable', tribe: 'judah', sources: ['1chr', 'matt', 'luke'], chroniclesRef: '1 Chr 3:19', crossReferences: ['Ezra 2:2', 'Ezra 3:2-8', 'Hag 1:1', 'Zech 4:6-10', 'Matt 1:12-13'], roles: ['governor'], description: 'Led the first return from Babylonian exile. Rebuilt the Temple. In the lineage of Christ. Called "son of Shealtiel" in Ezra and Haggai, but son of Pedaiah in 1 Chronicles.' },
  ...
  { id: 'hattush', name: 'Hattush', significance: 'minor', tribe: 'judah', sources: ['1chr'], chroniclesRef: '1 Chr 3:22', crossReferences: ['Ezra 8:2', 'Neh 3:10'], description: 'Son of Shemaiah.' },
