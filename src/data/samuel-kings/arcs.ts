...
export const characterArcs: Record<string, ArcPoint[]> = {
  'saul': [
    ...
    { year: 1035, influence: 60, label: 'Unlawful sacrifice at Gilgal; first rebuke', ref: '1 Sam 13:13-14' },
  ...
  'elisha': [
    ...
    { year: 841, influence: 75, label: 'Blinds Aramean army; leads them to Samaria', ref: '2 Kgs 6:18-20' },
    { year: 840, influence: 80, label: 'Prophesies end of siege and famine in Samaria', ref: '2 Kgs 7:1' },
    { year: 841, influence: 90, label: 'Sends prophet to anoint Jehu; triggers revolution', ref: '2 Kgs 9:1-3' },
    { year: 810, influence: 65, label: 'Continued ministry through multiple kings', ref: '2 Kgs 8:4' },
