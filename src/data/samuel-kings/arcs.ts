...
export const characterArcs: Record<string, ArcPoint[]> = {
  'saul': [
    ...
    { year: 1040, influence: 70, label: 'Wars against Philistines', ref: '1 Sam 14:47-48' },
  ...
  'solomon': [
    ...
    { year: 945, influence: 85, label: 'Massive building projects; forced labor', ref: '1 Kgs 9:15-22' },
  ...
  'elijah': [
    { year: 870, influence: 30, label: 'Declares drought; fed by ravens', ref: '1 Kgs 17:1-6' },
    ...
    { year: 867, influence: 15, label: 'Flees to Horeb in fear of Jezebel', ref: '1 Kgs 19:3-4' },
    { year: 866, influence: 50, label: 'Recommissioned; calls Elisha', ref: '1 Kgs 19:15-21' },
  ...
  'elisha': [
    ...
    { year: 848, influence: 55, label: 'Multiplies widow\'s oil; raises Shunammite\'s son', ref: '2 Kgs 4:1-37' },
    ...
    { year: 820, influence: 60, label: 'Ongoing ministry through multiple reigns', ref: '2 Kgs 6:12' },
    { year: 798, influence: 70, label: 'Final prophecy to Jehoash; dies', ref: '2 Kgs 13:14-20' },
  ],

  'ahab-king': [
    { year: 874, influence: 50, label: 'Becomes king; marries Jezebel', ref: '1 Kgs 16:29-31' },
    { year: 870, influence: 40, label: 'Drought proclaimed by Elijah', ref: '1 Kgs 17:1' },
    { year: 867, influence: 35, label: 'Humiliated at Mount Carmel', ref: '1 Kgs 18:40' },
    { year: 862, influence: 65, label: 'Defeats Ben-hadad twice', ref: '1 Kgs 20:21,29' },
    { year: 860, influence: 70, label: 'Peak military power; Israelite coalition', ref: '1 Kgs 20:34' },
    { year: 856, influence: 55, label: 'Naboth\'s vineyard; Elijah\'s curse', ref: '1 Kgs 21:19' },
  ...
  'hezekiah': [
    { year: 715, influence: 50, label: 'Becomes king; launches reforms', ref: '2 Kgs 18:1-6' },
    ...
    { year: 701, influence: 85, label: 'Prays; angel destroys 185,000 Assyrians', ref: '2 Kgs 19:35' },
    { year: 701, influence: 90, label: 'Healed of illness; 15 years added', ref: '2 Kgs 20:5-6' },
    { year: 700, influence: 60, label: 'Shows treasures to Babylonian envoys (unwise)', ref: '2 Kgs 20:12-15' },
  ...
  'josiah': [
    ...
    { year: 622, influence: 85, label: 'Book of the Law found; great reform', ref: '2 Kgs 22:8-23:25' },
    { year: 622, influence: 90, label: 'Celebrates the greatest Passover', ref: '2 Kgs 23:21-23' },
    { year: 615, influence: 80, label: 'Judah enjoys peace and reform', ref: '2 Kgs 23:25' },
