...
const PROPHETS: Prophet[] = [
  ...
  { id: 'elijah',   name: 'Elijah',   start: 870,  end: 848,  message: '"The LORD, He is God!" — confronted Baal worship',              ref: '1 Kgs 18:39',      targetKings: ['ahab-king', 'ahaziah-israel'] },
  ...
  { id: 'hosea',    name: 'Hosea',    start: 750,  end: 715,  message: 'God\'s faithful love despite Israel\'s unfaithfulness',         ref: 'Hosea 2:19-20',    targetKings: ['jeroboam-ii', 'menahem', 'pekah', 'hoshea', 'azariah-king', 'jotham', 'ahaz', 'hezekiah'] },
  ...
  { id: 'jeremiah', name: 'Jeremiah', start: 627,  end: 586,  message: 'New covenant coming, judgment on unfaithful Judah',             ref: 'Jer 31:31-34',     targetKings: ['josiah', 'shallum-josiah', 'jehoiakim', 'jehoiachin', 'zedekiah-king'] },
];
